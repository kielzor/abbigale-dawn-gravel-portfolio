    ...
    <div className="tech-skills-section">
      <div className="tech-skills-containers">
        <h2 className="tech-skills-subheader">
          I am familiar with every phase of the UX design process, including the
          following and more:
        </h2>
      ...
      <div className="tech-skills-containers">
        ...
        <h2 className="tech-skills-subheader">
          I use many tools and resources to create delightful and efficient User
