    ...
    <div className="resume-section">
      ...
      <div className="resume-main-container">
        <div className="resume-main-columns">
          ...
          <p className="work-sub-text work-sub-header">
            Denver University Trilogy Bootcamp
          </p>
          <p className="work-sub-text">As of May 2021</p>
          <h4 className="experience-headers">Tutor and Caregiver</h4>
          <p className="work-sub-text">
          ...
          <p className="work-sub-text">Aug 2020 - Dec 2020</p>
          <h4 className="experience-headers">Café/Store Manager</h4>
          <p className="work-sub-text">General manager/hiring manager role</p>
          <p className="work-sub-text work-sub-header">
            Curds Cheese/Nook Coffee: Littleton Colorado
          </p>
          <p className="work-sub-text">Apr 2019 - Apr 2020</p>
          ...
          <p className="work-sub-text">2017 - present</p>
        </div>
        <div className="resume-main-columns">
          <h2 className="work-header">Titles</h2>
          <p>
