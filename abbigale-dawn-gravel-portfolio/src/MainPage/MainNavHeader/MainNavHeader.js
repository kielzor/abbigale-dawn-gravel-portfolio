      ...
      <div className='main-nav-container'>
        <div className='main-nav-primary-container'>
          <div className='logo-container' 
            ...
            <img src={main} alt='Abbigale Dawn Personal Logo' 
                className='main-nav-logo'/>
            <h3 className='logo-text'>Abbigale Dawn Gravel</h3>
          </div>
          <div className='nav-text-container' onMouseLeave={() => handleDropdown(false)}>  
            <div onMouseEnter={() => handleDropdown(true)}>
              <h2 className='main-nav-text'
                  >Work</h2>
              {this.isWorkExpanded && (
                <div className='work-subheader-container'>
                  <h2 className='sub-nav-text' onClick={() => this.handleNavClick('work')}>Tech</h2>
                  <h2 className='sub-nav-text' onClick={() => this.handleNavClick('music')}>Music</h2>
                  <h2 className='sub-nav-text' onClick={() => this.handleNavClick('writing')}>Writing</h2>
                </div>
              )}
            </div>    
            <h2 className='main-nav-text'
